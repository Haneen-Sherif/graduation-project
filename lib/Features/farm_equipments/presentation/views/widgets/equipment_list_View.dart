...
class _EquipmentListViewState extends State<EquipmentListView> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider.of<EquipmentsCubit>(context).equipmentsList.length == 0
        ? Align(
              ...
              children: [
                ...
                Text(
                  ...
                  style: Styles.textStyle20(context)
                      .copyWith(color: Color(0xffB6BAC3)),
                )
              ],
            ),
          )
        : BlocBuilder<EquipmentsCubit, EquipmentsState>(
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: CustomFarmEquipmentItem(
                                  ...
                                  edit: () {
                                    context.push(AppRoutes.kEditEquipmentView,
                                        extra: {
                                          'id': widget.id,
